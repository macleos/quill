...
angular
  ...
  .constant("DASHBOARD", {
    ...
    INCOMPLETE:
      "If you do not complete your application before [APP_DEADLINE], you will not be considered for a place!",
    ...
    CLOSED_AND_INCOMPLETE_TITLE:
      "Unfortunately, registration has closed, and the selection process has begun.",
    CLOSED_AND_INCOMPLETE:
      "Because you have not completed your profile in time, you will not be eligible for the selection process.",
    ...
    DECLINED:
      "We're sorry to hear that you won't be able to make it to Hack the Burgh 2020! :(\nMaybe next year! We hope you see you again soon."
  })
  .constant("TEAM", {
    NO_TEAM_REG_CLOSED:
      "Unfortunately, it's too late to enter the selection with a team.\nHowever, you can still form teams on your own before or during the event!"
  });
